...
const projects = [
  ...
  { id: 3, title: 'VirtualR Website', description: 'Skills Used: Vite+React.js TailwindCSS Framer-Motion', image: require('/src/assets/project3.png'), link: 'https://landing-page-3dpjrrx48-ionutpetru4046s-projects.vercel.app/' },
  { id: 4, title: 'Sample Landing Page', description: 'Skills Used: Vite+React.js TailwindCSS', image: require('/src/assets/project4.png'), link: 'https://simple-landing-page-nu.vercel.app/' },
  { id: 5, title: 'React.js Task Tracker App', description: 'Skills USed: React.js, Nodejs NPM Manager', image: require('/src/assets/project5.png'), link: 'https://ionutpetru4046.github.io/Task-Tracker-react.js/' },
  { id: 6, title: 'E-ecommerce Shop', description: 'HTML CSS Javascript,', image: require('/src/assets/project6.png'), link: 'https://ionutpetru4046.github.io/ecommerce/index.html' },
];
